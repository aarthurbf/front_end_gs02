      ...
      <section>
        <div className="container">
          ...
          <div className="content">
            ...
            <p>
              Os painéis solares captam a luz do sol e a convertem em
              eletricidade através de células fotovoltaicas.
            </p>
          </div>
        </div>
      </section>
      ...
      <section>
        <div className="selection-container">
          ...
          <p className="selection-text">
            Para tornar a energia solar acessível e contribuir para um futuro
            mais verde, iremos adotar soluções modulares e personalizadas
            juntamente com ações de educação e conscientização. A
            disponibilização de kits solares residenciais em sistemas modulares
            permite que as pessoas iniciem com uma configuração básica, que pode
            ser ampliada ao longo do tempo de acordo com as necessidades e
            possibilidades financeiras. Além disso, iniciativas como a
            instalação de painéis em áreas comunitárias, como telhados de
            prédios ou centros de uso comum, permitem que várias famílias
            compartilhem a energia gerada, o que reduz o custo individual e
            facilita o acesso à energia limpa.
          </p>
        </div>
        <div className="selection-container">
          ...
          <p className="selection-text">
            ...
            eficientes e duradouros, tornando-se uma opção economicamente
            viável. A longo prazo, o uso de energia solar contribui
